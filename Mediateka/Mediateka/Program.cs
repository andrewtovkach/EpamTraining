...
namespace Mediateka
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            album.Add(new AudioItem("SOAD - Suite-Pee", 13.6, new DateTime(2015, 1, 4), Popularity.Five, 
                new TimeSpan(0, 3, 20), 320));
            album.Add(new AudioItem("SOAD - Know", 3.56, new DateTime(2015, 2, 1), Popularity.Four, 
                new TimeSpan(0, 4, 21), 320));
            album.Add(new AudioItem("SOAD - Sugar", 1.26, new DateTime(2013, 6, 4), Popularity.Five, 
                new TimeSpan(0, 3, 24), 320));
            mediateka["Music"].Add(album);
            Serial serial = new Serial("Game of Thrones", new DateTime(2010, 2, 6), "HBO", "USA");
            serial.Add(5, new VideoItem("GameOfThrones s5e3", 1009.08, new DateTime(2015, 6, 9), 
                Popularity.Three, new TimeSpan(1, 7, 0), new ScreenResolution { Height = 1280, Width = 720 }));
            serial.Add(5, new VideoItem("GameOfThrones s5e2", 1230.02, new DateTime(2015, 6, 5), 
                Popularity.Four, new TimeSpan(1, 6, 8), new ScreenResolution { Height = 1280, Width = 720 }));
            serial.Add(4, new VideoItem("GameOfThrones s4e1", 1125.01, new DateTime(2014, 6, 5), 
