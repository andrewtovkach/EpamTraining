...
namespace ATSProject
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Contract("1001", "+375(17)275-75-25", new TariffPlan("Active", 50, 150), "2015-10-1"),
                new Contract("1002", "+375(152)24-15-10", new TariffPlan("Middle", 20, 250), "2015-11-4"),
                new Contract("1003", "+375(1512)2-70-15", new TariffPlan("Light", 10, 500), "2015-10-14")
            },
            new List<Client>
            {       
